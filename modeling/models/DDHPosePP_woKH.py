...
class DDHPosePP_woKH(nn.Module):
    """
    Implement DDHPose
    """
    def __init__(self, num_frame=234, num_joints=17, in_chans=2, embed_dim_ratio=512, depth=8,
                 num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,
        ...
        self.dir_bone_estimator = STDenoiser(num_frame=num_frame, num_joints=num_joints, in_chans=in_chans, embed_dim_ratio=embed_dim_ratio, 
