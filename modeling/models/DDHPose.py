...
class  HSTDenoiser(nn.Module):
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
                 ...
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.2,  norm_layer=None,  boneindex=None, rootidx=0, boneindextemp=None):
...
class DDHPose(nn.Module):
    ...
    def __init__(self, num_frame=234, num_joints=17, in_chans=2, embed_dim_ratio=512, depth=4,
        ...
        self.dir_bone_estimator = HSTDenoiser(num_frame=num_frame, num_joints=num_joints, in_chans=in_chans, embed_dim_ratio=embed_dim_ratio, 
                                              ...
                                              drop_path_rate=drop_path_rate, boneindex=self.boneindex, rootidx=self.rootidx, boneindextemp=boneindextemp)
    ...
    def forward(self, inputs_2d, inputs_3d, input_2d_flip=None, istrain=False, inputs_act=None):
        ...
        if self.is_train:
            ...
            # flops = FlopCountAnalysis(self.dir_bone_estimator, (inputs_2d, x_dir, x_bone_length, t, True))
