...
# ---------- DDHPOSE 输出与返回 ----------
def report_and_return_ddhpose(cfg, predicted_3d_pos_single, inputs_traj_single, inputs_3d_single, inputs_2d_single, cam, p1_dict, p2_dict):
...
def evaluate( cfg, 
    ...
    with torch.no_grad():
        ...
        for cam, batch_3d, batch_2d in test_loader:
            cam = cam.squeeze(0)
            ...
            for batch_cnt in range(total_batch):
                ...
                if model_name == 'DDHPose':
                    report_and_return_ddhpose(cfg, predicted_3d_pos_single, inputs_traj_single, inputs_3d_single, inputs_2d_single, cam, p1_dict, p2_dict)
                else:
