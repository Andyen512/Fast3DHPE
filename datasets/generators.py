...
class UnchunkedGenerator_Seq:
    ...
    def __init__(self, cameras, poses_3d, poses_2d, pad=0, causal_shift=0,
                 augment=False, kps_left=None, kps_right=None, joints_left=None, joints_right=None, rank=0, world_size=1):
...
class PoseChunkDataset(Dataset):
...
class PoseUnchunkedDataset(Dataset):
    def __init__(self, poses_2d, poses_3d=None, cameras=None,
